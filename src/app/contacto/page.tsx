...
export default function ContactoPage() {
  ...
  const officeDetails = {
    roma: {
      ...
      iframeUrl: "https://maps.google.com/maps?q=Dr.+David+Ernesto+Hern%C3%A1ndez+Torres+Cirujano+General,+Calle+Durango+64,+Roma+Norte,+CDMX&t=&z=16&ie=UTF8&iwloc=&output=embed"
    },
    polanco: {
      name: "Polanco",
      ...
      iframeUrl: "https://maps.google.com/maps?q=Dr.+David+Ernesto+Hern%C3%A1ndez+Torres+Cirujano+General,+Calle+Tem%C3%ADstocles+210,+Polanco,+CDMX&t=&z=16&ie=UTF8&iwloc=&output=embed"
    }
  };
